...
export const productService = {
  ...
  toggleActivo: (id) => api.patch(`${MS_PRODUCT_URL}/product/${id}/toggle-activo`)
};
...
export const inventoryService = {
  getInventory: (sede_id) =>
    api.get(`${MS_INVENTORY_URL}/inventory/`, { params: { sede_id } }),

  createInventory: (data) =>
    api.post(`${MS_INVENTORY_URL}/inventory/`, data),

  updateStock: (id, data) =>
    api.put(`${MS_INVENTORY_URL}/inventory/${id}`, data),
